...
## 选题方法论（**最上位入口**：换课题/开新方向时先读这份）

| 文档 | 用途 |
|---|---|
| [`TOPIC_METHODOLOGY.md`](TOPIC_METHODOLOGY.md) | **可复用的选题方法论 v1.0**：第一原则（只做真痛点）→ 真痛点四条件 → **伪问题七形态** → 自检十问 → 量级等级 L0–L3 → **审核流程图** → 三级判定 T0/T1/T2 → **判定纪律七条** → 五套模板 + 结题 12 项审计清单 + 实证索引 |
