...
$ meson setup -Dbuild_docs=true
$ cd 
$ ninja

# Documentation will be generated in /html
# After installation (ninja install), documentation will be available in /share/doc/nixl/
```
