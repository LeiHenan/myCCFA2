...
**当前阶段（2026-09-12 更新）**：✅ 新机器已就位并通过验收（RTX PRO 6000 Blackwell 96 GB / 驱动 580.82.09 / vLLM 0.29.0）。三条实验全部跑完：
...
- **E1 = `#1` 判死**（`R_byte` p95 0.072% ≪ 5%）**+ D3「消除保守预留」支线触发**（比值 5.39 > 2，但量级警示：本质是 block 取整）。
⇒ **下一步决策见 `notes/decision_log.md` #47–#49 与 `results/p06-frontier/2026-09-12/T2-verdict.md` §6**（portfolio 需重排：主线空缺，唯一被预登记规则启动的新线是 D3）。
